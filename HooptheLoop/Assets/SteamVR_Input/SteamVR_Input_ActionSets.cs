...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_HooptheLoop p_HooptheLoop;
        ...
        public static SteamVR_Input_ActionSet_HooptheLoop HooptheLoop
        {
            get
            {
                return SteamVR_Actions.p_HooptheLoop.GetCopy<SteamVR_Input_ActionSet_HooptheLoop>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_HooptheLoop = ((SteamVR_Input_ActionSet_HooptheLoop)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_HooptheLoop>("/actions/HooptheLoop")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.HooptheLoop};
        }
    }
}
